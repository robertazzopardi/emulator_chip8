...
impl Chip8 {
    ...
    fn emulate(&mut self) {
        ...
        match self.opcode & 0xF000 {
            ...
            0x6000 => {
                ...
                self.g_reg[((self.opcode & 0x0F00) >> 8) as usize] = (self.opcode & 0x00FF) as u8;
                self.pc += 2;
            }
            0x7000 => {
            ...
            0x8000 => {
                match self.opcode & 0x000F {
                    ...
                    0x0006 => {
                        ...
                        self.g_reg[0xF] = self.g_reg[((self.opcode & 0x0F00) >> 8) as usize] & 0x1;
                    ...
                    0x000E => {
                        ...
                        self.g_reg[0xF] = self.g_reg[((self.opcode & 0x0F00) >> 8) as usize] >> 7;
                        self.g_reg[((self.opcode & 0x0F00) >> 8) as usize] <<= 1;
                        self.pc += 2;
                    }
                    _ => {
            ...
            0xE000 => {
                match self.opcode & 0x00FF {
                    0x009E => {
                        ...
                        if self.key[(self.g_reg[((self.opcode & 0x0F00) >> 8) as usize]) as usize]
                            != 0
                        {
                            self.pc += 4;
                        } else {
            ...
            0xF000 => {
                match self.opcode & 0x00FF {
                    ...
                    0x0029 => {
                        ...
                        self.ir = (self.g_reg[((self.opcode & 0x0F00) >> 8) as usize] * 0x5) as u16;
                        self.pc += 2;
                    }
                    0x0033 => {
    ...
    fn update_quads(&mut self, canvas: &mut Canvas<Window>) {
        for y in 0..32 {
            for x in 0..64 {
